...
use Drupal\drupal_yext\Annotation\YextPluginAnnotation;

/**
 * A plugin manager YextPlugin plugins.
 *
 * The YextPluginManager class extends the DefaultPluginManager to
 * provide a way to manage YextPlugin plugins. A plugin manager defines
 ...
 * YextPlugin plugin type to use annotated discovery.
 *
 * The plugin manager is also declared as a service in
 * drupal_yext.services.yml so that it can be easily accessed and used
 * anytime we need to work with YextPlugin plugins.
 *
...
// @codingStandardsIgnoreEnd
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_interface = YextPluginInterface::class;

    // The name of the annotation class that contains the plugin definition.
    $plugin_definition_annotation_name = YextPluginAnnotation::class;
    ...
    // backend. For our YextPlugin plugin type, we've specified the
